...
export const cdmaIntegrationCatalogue: CatalogueDataset[] = [
  {
    ...
    retainedExcerpt: true,
    completePayload: true,
    payloadEvidence: 'AUTHENTICATED · 64,368/64,368 ROWS RETAINED 2026-09-08, 12 AUG COMPLETED FROM EXPORT · 100% FILLED, 95.6% OF COLLECTION ON ONE DAY',
  ...
  },
  {
    ...
    retainedExcerpt: true,
    completePayload: true,
    payloadEvidence: 'AUTHENTICATED · 64,368/64,368 ROWS RETAINED 2026-09-08, 12 AUG COMPLETED FROM EXPORT · 100% FILLED, 94.7% OF SEGREGATION ON ONE DAY',
    joinEligibility: 'SECRETARIAT · DAY GRAIN · TOO LARGE TO BUNDLE · REACHES THE APP AS A CONTINUITY SUMMARY',
    scoringEligibility: 'UNSCORED',
    sourceState: 'AUTHORIZED',
    sourceGrain: 'Secretariat · Day',
