 ...
 * zero, so a first-week rate blends six other days with one recurring low-reporting day
 * and lands about twelve points below the figure without it. Both readings are true of
